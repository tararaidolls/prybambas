// Inventor Lab — ja
const inventor_db_ja = {
  ui: {
    title: "発明家のように考えよう",
    howItWorks: "使い方",
    start: "スタート",
    menuNote: "上のアイコンをタップしてプレビューし、スタートを押してね。",
    calPrompt: "日付をタップして観察チャレンジを表示！",
    dayLabel: "日",
    example: "例：",
    submitCoach: "AIコーチに送信",
    writePlaceholder: "アイデアをここに書いてね...",
    useAllItems: "3つのアイテムをすべて使おう。",
    writeFirst: "まず発明の解決策を書いてね！",
    rookie: "ルーキー",
    agent: "エージェント",
    elite: "エリート",
    rookieSub: "ヒント付き・かんたん",
    agentSub: "ふつう",
    eliteSub: "制限付き・むずかしい"
  },
  menu: {
  ...
  promo: {
    t: "ゲームは好き？",
    st: "Amazonで「Think Like an Inventor」ワークブックを！",
    btn: "購入",
    backHub: "← Hub"
  }
};

const inventor_missions_ja = inventor_missions_en;
