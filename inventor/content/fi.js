// Inventor Lab — fi
const inventor_db_fi = {
  ui: {
    title: "Ajattele keksijän tavoin",
    howItWorks: "Näin se toimii",
    start: "ALOITA",
    menuNote: "Napauta yläpuolen kuvaketta esikatseluun, sitten Aloita.",
    calPrompt: "Napauta päivää nähdäksesi havaintotehtävän!",
    dayLabel: "Päivä",
    example: "Esimerkki:",
    submitCoach: "Lähetä AI-valmentajalle",
    writePlaceholder: "Kirjoita ideasi tähän...",
    useAllItems: "Käytä kaikkia 3 esinettä.",
    writeFirst: "Kirjoita ratkaisusi ensin!",
    rookie: "ALOITTELIJA",
    agent: "AGENTTI",
    elite: "ELIITTI",
    rookieSub: "Helppo, vihjeillä",
    agentSub: "Keskitaso",
    eliteSub: "Vaikea, rajoituksin"
  },
  menu: {
    m1: "Työkalut ja esimerkit",
    m2: "Havaintokalenteri",
    m3: "Haasteet työkaluittain",
    m4: "Mission Possible",
    back: "Takaisin",
    backMenu: "Takaisin valikkoon",
    genBtn: "Luo tehtävä",
    tcTitle: "Haasteen kuvaus"
  },
  ...
  promo: {
    t: "Pidätkö pelistä?",
    st: "Hanki «Think Like an Inventor» -työkirja Amazonista!",
    btn: "Osta",
    backHub: "← Hub"
  }
};

const inventor_missions_fi = inventor_missions_en;
